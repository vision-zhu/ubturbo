...
set(stdout_log "/root/ubturbo/3rdparty/spdlog-prefix/src/spdlog-stamp/spdlog-build-out.log")
set(stderr_log "/root/ubturbo/3rdparty/spdlog-prefix/src/spdlog-stamp/spdlog-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/ubturbo/3rdparty/spdlog-prefix/src/spdlog-stamp/spdlog-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "spdlog build command succeeded.  See also /root/ubturbo/3rdparty/spdlog-prefix/src/spdlog-stamp/spdlog-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
