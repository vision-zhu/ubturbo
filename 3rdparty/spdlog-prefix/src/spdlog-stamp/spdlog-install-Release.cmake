...
set(stdout_log "/root/ubturbo/3rdparty/spdlog-prefix/src/spdlog-stamp/spdlog-install-out.log")
set(stderr_log "/root/ubturbo/3rdparty/spdlog-prefix/src/spdlog-stamp/spdlog-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /root/ubturbo/3rdparty/spdlog-prefix/src/spdlog-stamp/spdlog-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "spdlog install command succeeded.  See also /root/ubturbo/3rdparty/spdlog-prefix/src/spdlog-stamp/spdlog-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
