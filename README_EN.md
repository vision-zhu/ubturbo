...
- RPM packaging uses the repository-root `ubturbo.spec` through `rpmbuild`; use the generated package metadata as the authoritative version source.
...
- [Capability migration](docs/ubturbo_capability_migration.md) (Chinese)
