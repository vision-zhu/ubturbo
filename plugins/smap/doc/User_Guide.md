...
5. 进入以下目录，载入迁移驱动。
   ...
   * 容器场景
     <pre class="screen" id="ZH-CN_TOPIC_0000002029393654__screen10449144916557"><p class="p" id="p4962648122720">insmod smap_tiering.ko smap_scene=2</p><p class="p" id="p4962648122721"># 用户态调用: ubturbo_smap_start(PAGETYPE_NORMAL, ...)</p></pre>
   * 虚拟化场景
     <pre class="screen" id="screen10850151716211"><p class="p" id="p1296384811277">insmod smap_tiering.ko smap_scene=2</p><p class="p" id="p1296384811278"># 用户态调用: ubturbo_smap_start(PAGETYPE_HUGE, ...)</p></pre>
