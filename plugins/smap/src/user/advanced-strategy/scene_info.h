...
#define EXIT_UNSTABLE_THRESHOLD_RATIO 0.01
...
/* migrate cycle - 虚机 */
#define UNSTABLE_MIGRATE_CYCLE 3000
#define HEAVY_STABLE_MIGRATE_CYCLE 2000
#define LIGHT_STABLE_MIGRATE_CYCLE 2000

/* migrate cycle - 普通进程 */
#define PROCESS_UNSTABLE_MIGRATE_CYCLE 3000
#define PROCESS_HEAVY_STABLE_MIGRATE_CYCLE 3000
#define PROCESS_LIGHT_STABLE_MIGRATE_CYCLE 3000

/* scan time - 虚机 */
#define VM_UNSTABLE_SCAN_CYCLE 2000
#define VM_HEAVY_STABLE_SCAN_CYCLE 200
#define VM_LIGHT_STABLE_SCAN_CYCLE 200

/* scan time - 普通进程 */
#define PROCESS_UNSTABLE_SCAN_CYCLE 3000
#define PROCESS_HEAVY_STABLE_SCAN_CYCLE 3000
#define PROCESS_LIGHT_STABLE_SCAN_CYCLE 3000
